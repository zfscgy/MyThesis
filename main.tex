...
\major{计算机科学与技术}
\supervisor{李金龙\ 副教授}
\cosupervisor{郑小林\ 副教授}
% \date{二〇一七年五月一日} % 注释掉则为今日
% \professionaltype{专业学位类型}
% \secretlevel{秘密}        % 绝密|机密|秘密，注释本行则不保密
% \secretyear{20}           % 保密年限

\entitle{Deep Learning in Financial Risk Management}
\enauthor{Fei Zheng}
\enmajor{Computer Science and Technology}
\ensupervisor{Asso. Prof. Jinlong Li}
\encosupervisor{Asso. Prof. Xiaolin Zheng}
...
\frontmatter
\input{chapters/my_acknowlegement.tex}

%\input{chapters/abstract}
\tableofcontents

\input{chapters/my_abstract.tex}
% \listoffigures
% \listoftables
...
\input{chapters/my_related_theory_overview.tex}
\input{chapters/my_data_refinement.tex}
\input{chapters/my_data_imputation.tex}
\input{chapters/my_model_realiazation.tex}
\input{chapters/my_conclusion_and_expectation.tex}
